...
*/
function Hamburger(bun, meatPatty, pattyCount, garnishes, cheeses, sauces, toppings) {
    this.bun = bun;
    ...
    this.describe = function () {
        ...
        if (this.garnishes.length > 0) {
            description += `garnished with ${this.garnishes.join(', ')}, `;
        }
...
const myHamburger = new Hamburger('sesame seed', 'beef', 1, ['lettuce', 'tomato', 'onion'], ['cheddar'], ['ketchup', 'mayo'], ['pickles', 'hot peppers']);
